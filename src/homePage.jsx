            ...
            <Layout>
                ...
                <Layout>
                    <Header style={{background: '#fff', padding: 0}}>
                        {collapsed ? <MenuFoldOutlined onClick={() => toggle(collapsed = !collapsed)}/> :
                            <MenuUnfoldOutlined onClick={() => toggle(collapsed = !collapsed)}/>}
                    </Header>
                    <Content
                        style={{
                            margin: '24px 16px',
                    ...
                    >
                        ...
                        <Route path='/MyApp' render={() => <MyApp names={['1', '2']}/>}/>
